...
-- select workspace
CREATE OR REPLACE MATERIALIZED VIEW main.dbsql_warehouse_advisor.workspaces
...
CREATE OR REPLACE MATERIALIZED VIEW main.dbsql_warehouse_advisor.warehouses
SCHEDULE EVERY 1 HOUR
